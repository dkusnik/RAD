...
Image* filter_rad(const char* variant, const Image* in_img, const int r, const int f, const int alpha, const float sigma, const float sigmai);
...
typedef enum
{
	...
	ROAD_LMAX,
	ROAD2_LMAX,
} ROADMeasure; /**< ROAD Measures types Enumeration */

float avg_road(const Image* in_img, const int alpha, const ROADMeasure variant);
